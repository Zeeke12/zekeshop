    ...
    <header className="bg-red-200 sticky-top">
      <nav className="bg-gradient-to-r from-emerald-500 via-emerald-300 to-emerald-700 mx-0 flex items-center justify-between p-6 lg:px-8 " aria-label="Global">
        ...
        <Popover.Group className="hidden lg:flex lg:gap-x-12 bg-transparent">
          ...
          <a href="/" className="bg-transparent border-1 pl-2 pb-1 border-green-600 text-xl  leading-6 text-gray-900">
            Home
          </a>
          <a href="/about" className="bg-transparent border-1 pl-2 pb-1 border-green-600 text-xl  leading-6 text-gray-900">
            About
          </a>
          <a href="/products" className="bg-transparent border-1 pl-2 pb-1 border-green-600 text-xl  leading-6 text-gray-900">
            Products
          </a>
          <a href="/cart" className="bg-transparent border-1 pl-2 pb-1 border-green-600 text-xl  leading-6 text-gray-900">
